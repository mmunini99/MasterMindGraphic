...
public class Difficulty {
    ...
    // public int getNumberOfColors(String difficulty){
    //     // Return the number of colors corresponding to the difficulty
    //     switch (difficulty){
    //         case EASY:
    //             return 3;
    //         case MEDIUM:
    ...
    // public int getNumberOfTrials(String difficulty){
    //     // Return the number of trials corresponding to the difficulty
    //     switch (difficulty){
    //         case EASY:
    //             return 15;
    //         case MEDIUM:
    ...
    // public int getLengthOfSequence(String difficulty){
    //     // Return the length of the sequence corresponding to the difficulty
    //     switch (difficulty){
    //         case EASY:
    //             return 3;
    //         case MEDIUM:
